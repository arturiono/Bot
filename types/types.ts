...
export interface Rashodniki {
    [key: string]: {
        name:string, 
        count: number,
        over: number, //количество, которое больше чем на складе
        units: string,
        // поле доступное только в оперативной памяти на клиенте
        reserved?: number, //количество, которое зарезервировано в сохраненной заявке
        // используется для подсчета общего количества доступных расходников
    }
} 
